export const dict = {
	...
	"msg_specify_mediator_for_bill": "Если используется приобретение товара через посредника, должен быть выбран конкретный посредник для управления расчетами с ним!"
